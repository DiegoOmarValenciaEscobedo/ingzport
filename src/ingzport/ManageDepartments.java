...
public class ManageDepartments extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        DepartmentTable.setFont(new java.awt.Font("HelvLight", 0, 12)); // NOI18N
        ...
        TittleLabel.setText("Registro y administracion de departamentos");
        ...
        DescriptionLabel.setText("Nombre de departamento:");
    ...
    public void ReadDataBase() {
        int i = 0;
        int rn = DepartmentTable.getRowCount();
        DefaultTableModel table = (DefaultTableModel) DepartmentTable.getModel();
        while (i < rn) {
            table.removeRow(0);
            i++;
        }
        try {
            ...
            while (rs.next()) {
                String Row[] = new String[]{rs.getString("ClaveD"), rs.getString("Descripcion")};
                table.addRow(Row);
            }
    ...
    private void ModifyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModifyButtonActionPerformed
        ...
        if (i == -1)
            ...
            try {
                int id = Integer.parseInt(DepartmentTable.getValueAt(i, 0).toString());
                Statement st;
                st = con.createStatement();
                st.executeUpdate("UPDATE departamento SET Descripcion='"+DescriptionTextField.getText()+"' WHERE ClaveD=" + id);
                ReadDataBase();
                JOptionPane.showMessageDialog(null, "Se Actualizaron los datos del departamento", "Listo", JOptionPane.INFORMATION_MESSAGE);
            } catch (SQLException ex) {}
        }
    ...
    private void DeleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteButtonActionPerformed
        ...
        if (i == -1)
            ...
            try {
                ...
                Statement st;
                st = con.createStatement();
                st.executeUpdate("DELETE FROM departamento WHERE ClaveD=" + id);
                DefaultTableModel table = (DefaultTableModel) DepartmentTable.getModel();
                table.removeRow(i);
                JOptionPane.showMessageDialog(null, "Se elimino el departamento de la lista", "Listo", JOptionPane.INFORMATION_MESSAGE);
            } catch (SQLException ex) {
    ...
    private void AddButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddButtonActionPerformed
        try { 
            ...
            if("".equals(DescriptionTextField.getText())) {
                ...
                st.execute("INSERT INTO `departamento` (`ClaveD`,`Descripcion`)"+ "VALUES (NULL,'" +DescriptionTextField.getText()+ "')");
                JOptionPane.showMessageDialog(null, "Ahora este departamento esta en tu lista", "Listo", JOptionPane.INFORMATION_MESSAGE);
                ReadDataBase();
            }
        } catch (SQLException ex) {}
    ...
    private void ChargeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChargeButtonActionPerformed
        ...
        if (i == -1)
            ...
            DescriptionTextField.setText(DepartmentTable.getValueAt(i, 1).toString()); 
        }
